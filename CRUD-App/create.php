...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert_query = "
        INSERT INTO peserta (nama, sekolah, jurusan, no_hp, alamat)
...
<head>
  ...
  <title>Form Pendaftaran | Tambah Data</title>
...
<body>
  <div class="container my-5">
    ...
    <div class="alert alert-danger d-flex align-items-center gap-3" role="alert">
      ...
      <div>Data gagal ditambahkan</div>
    </div>
    <?php endif; ?>
    
    <h1 class="fs-3 mb-3">Tambahkan Peserta</h1>
